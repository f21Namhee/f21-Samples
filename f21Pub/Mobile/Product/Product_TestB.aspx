...
<div class="content_wrapper">
	...
	<div id="owl-product">
		<div class="item"><img src="//img.forever21.co.kr/images/default_750/00236782-06.jpg" class="photo-item" data-height="1125" data-width="750"/></div>
        <div class="item"><img src="//img.forever21.co.kr/images/2_side_750/00236782-06.jpg"  class="photo-item" data-height="1125" data-width="750"/></div>
        <div class="item"><img src="//img.forever21.co.kr/images/3_back_750/00236782-06.jpg"  class="photo-item" data-height="1125" data-width="750"/></div>
    </div>
    <!-- Product Slider : End -->
...
$(function(){  
   ...
   $(".photo-item").each( function( idx ) {
		   
	   imgsrc =  $(this).attr("src");    //-- 이미지 경로 
	   width = $(this).data("width");    //-- 이미지 최대 가로 크기 (확대시)  
	   height = $(this).data("height");  //-- 이미지 최대 세로 크기 (확대시)
	...
	function openPhotoSwipe( show_idx ) { 
		
	    var pswpElement = document.querySelectorAll('.pswp')[0];
	    var options = {      
		    index: show_idx,   //-- 클릭한 이미지가 보이게
	      	history: false,
	      	focus: false,
