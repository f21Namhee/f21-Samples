...
<div class="content_wrapper">
	...
	<div id="owl-product" class="photo-viewer">
		<div class="item photo-item"><img src="//img.forever21.co.kr/images/default_750/00236782-06.jpg" data-height="1125" data-width="750"/></div>
        <div class="item photo-item"><img src="//img.forever21.co.kr/images/2_side_750/00236782-06.jpg" data-height="1125" data-width="750"/></div>
        <div class="item photo-item"><img src="//img.forever21.co.kr/images/3_back_750/00236782-06.jpg" data-height="1125" data-width="750"/></div>
    </div>
    <!-- Product Slider : End -->
...
//----------------------------------------
//-- PhotoSwipe (f21jquery.js)에서 이동 
//----------------------------------------

$(function(){  
		
	var openPhotoSwipe = []; // interface function
	
	
	$("div.photo-viewer").each(function( main_idx ) {
	   
	   
	   var items = []; 
	   var imgsrc, width, height; 
	   var photo_item = $(".photo-item > img", this);
	   
	   
	   $(photo_item).each( function( idx ) {
		   ...
		   $(this).on("click", function() {
			   openPhotoSwipe[0]( idx );
		   });
		   
	   });
	   
	   
	   openPhotoSwipe[main_idx] = function( show_idx ) { //-- implements function
		    ...
		    var zoomPanel = new PhotoSwipe( pswpElement, PhotoSwipeUI_Default, items, options);
		    zoomPanel.init();
	   };
